...
data class TokenResponse(
    ...
    @JsonAlias("id_token") val idToken: String,
    @JsonAlias("expires_in") val expiresIn: Int,
    @JsonAlias("refresh_expires_in") val refreshExpiresIn: Int,
    @JsonAlias("token_type") val tokenType: String,
    @JsonAlias("not-before-policy") val notBeforePolicy: Int,
    @JsonAlias("session_state") val sessionState: String,
    val scope: String
)
